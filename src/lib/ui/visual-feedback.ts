...
export function markAsDiscarded(
	...
	applyMarkState(element, "discarded", VISUAL.DISCARDED_COLOR, "line-through", optionLetterSelector, optionTextSelector);
}
...
export function markAsMaybe(
	...
	applyMarkState(element, "maybe", VISUAL.MAYBE_COLOR, "underline", optionLetterSelector, optionTextSelector);
}
...
export function markAsConfident(
	...
	applyMarkState(element, "confident", VISUAL.CONFIDENT_COLOR, "underline", optionLetterSelector, optionTextSelector);
}

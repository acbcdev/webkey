...
import type { PopupUrlMapping } from "../use-popup-urls"

interface PopupUrlListProps {
	mappings: PopupUrlMapping[]
	onDelete: (domain: string) => void
	onEdit: (mapping: PopupUrlMapping) => void
}

export function PopupUrlList({
	mappings,
	onDelete,
	onEdit,
}: PopupUrlListProps) {

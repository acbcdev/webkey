			...
			<DialogContent className="sm:max-w-[500px]">
				...
				<div className="space-y-4 py-4">
					...
					<div className="space-y-2">
						...
						<Input value={domain} disabled className="bg-muted" />
					...
					<div className="space-y-2">
						...
						<Input value={origin} disabled className="bg-muted" />
						<p className="text-xs text-muted-foreground">
					...
					<div className="space-y-2">
						...
						<div className="text-sm text-muted-foreground break-all bg-muted rounded-md p-2 font-mono">
							{fullUrl || "Invalid URL"}
						</div>
					</div>
				</div>
